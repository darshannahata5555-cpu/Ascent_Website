...
// ─────────────────────────────────────────────────────────────
export function AscentLogo({ size = 22, withMark = true }) {
  return (
...
// ─────────────────────────────────────────────────────────────
export function NavBar({ active, onNav, variant = 'app' }) {
...
// ─────────────────────────────────────────────────────────────
export function NumberCounter({ to, duration = 1400, suffix = '', decimals = 0 }) {
...
// Placeholder poster
// ─────────────────────────────────────────────────────────────
export function PosterPlaceholder({ title = 'POSTER', sub = '700 × 400', w = 700, h = 400, tone = 'violet', style = {} }) {
...
// ─────────────────────────────────────────────────────────────
export function ImgPlaceholder({ w, h, label, tone = 'violet', style = {}, badge }) {
  const tones = {
...
// ─────────────────────────────────────────────────────────────
export function QRCode({ size = 180, seed = 'ASCENT-ABC123' }) {
  const cells = 21;
  const rng = (i) => {
    let h = 2166136261;
...
// ─────────────────────────────────────────────────────────────
export function PageBackground({ children, glows = true, bgImage = null, blurAmount = 18, dimAmount = 0.72 }) {
  return (
