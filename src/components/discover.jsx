...
import { useMobile, NavBar, PageBackground, PosterPlaceholder } from './shared';

export function Explore({ onNav }) {
...
export function Schedule({ onNav }) {
  const isMobile = useMobile();
...
export function Leaderboard({ onNav }) {
  const isMobile = useMobile();
